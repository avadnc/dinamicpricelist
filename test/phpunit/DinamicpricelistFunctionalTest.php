...
/**
 * \file    test/phpunit/DinamicpricelistFunctionalTest.php
...
/**
 * Class DinamicpricelistFunctionalTest
 *
 ...
 *
 * @package Testdinamicpricelist
 */
class DinamicpricelistFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDinamicpricelist')->click();
		} else {
			// Disable the module
			$this->byHref('modDinamicpricelist')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/dinamicpricelist/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dinamicpricelist/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dinamicpricelist/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dinamicpricelist/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dinamicpricelistwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDinamicpricelist_DinamicpricelistTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDinamicpricelist_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
